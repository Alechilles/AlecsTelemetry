...
A mod can send a general diagnostic bundle through the hosted event endpoint.
This package is separate from a manual player report. It can include:
...
or extract attachment contents in the portal.
