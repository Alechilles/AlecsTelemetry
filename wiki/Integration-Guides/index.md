...
These pages cover the files, runtime modes, consent behavior, and telemetry categories a modder uses to connect a Hytale plugin or asset pack to Alec's Telemetry.
