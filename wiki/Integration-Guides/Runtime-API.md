...
per project. Each package-prefix value is limited to 512 characters before
normalization. Longer values are omitted and reported as truncated. Disabling
performance consent clears the project's history.
