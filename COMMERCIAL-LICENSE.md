...
Beacon is published under the custom runtime license in the root
`LICENSE` file.

That public license already allows free, paid, commercial, and non-commercial
Hytale projects to use and ship unmodified copies of Beacon as a
...
- using Beacon in your own Hytale mod
- using Beacon in a paid or free Hytale mod
- using Beacon in a modpack or server project
- requiring Beacon as an unmodified dependency
- bundling an unmodified copy through documented embedded-mode packaging
- sending telemetry from your own Hytale project to Beacon's hosted service
...
- modifying Beacon and distributing the modified version
- publishing a fork, port, rebrand, translation, patch set, or derivative work
- redistributing Beacon as a standalone package, SDK, toolkit, mirror,
  or alternate download
- selling, sublicensing, renting, leasing, reselling, or white-labeling Beacon
...
- integrating Beacon into a commercial service offering where telemetry
...
- rights to BeaconPlatform or other separate repositories
...
- whether Beacon will be modified
...
Licensor: Alec (Alechilles)

Initial contact path:
